...
public class LoginAuthRespHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        Message.NetMessage handshakeRespMsg = (Message.NetMessage) msg;
        ...
        int handshakeMsgId = Integer.parseInt(handshakeMsg.getMessageid());
        if (handshakeMsgId == Integer.parseInt(handshakeRespMsg.getMessageid())) {
